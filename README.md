...
- `hall-of-fame/` — one static page per app at `/hall-of-fame/<author>/<app>/`, plus `sitemap.xml` and `robots.txt`. Generated by `scripts/pages.py` and committed, so link previews and crawlers get real HTML. Never hand-edited.
